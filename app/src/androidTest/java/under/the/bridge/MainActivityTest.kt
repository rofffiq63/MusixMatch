...
class MainActivityTest {
    ...
    fun stubDataManagerGetPokemonList(single: Single<List<String>>) {
        `when`(mComponent.mockDataManager.getTrackArtist(ArgumentMatchers.anyInt()))
                .thenReturn(single)
    }
